...
/* physical constants */
static const double c = 299792458e0;	// speed of light
static const double G = 6.673e-11;		// Gravitational constant
static const double SB = 5.6704e-8;     // stefan boltzman constant
